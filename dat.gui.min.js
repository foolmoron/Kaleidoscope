...
/***/ function(module, exports, __webpack_require__) {
	...
	/** @lends dat.gui.GUI */
	{
	  ...
	  destroy: function destroy() {
	    // destroy all folders first
	    for (var folder in this.__folders) {
	    	this.__folders[folder].destroy();
	    }
	    this.destroyed = true;

	    if (this.autoPlace && this.domElement.parentNode == autoPlaceContainer) {
	...
	function updateDisplays(controllerArray) {
	  if (controllerArray.length !== 0) {
	    if (controllerArray[0].__gui.destroyed) {
	      // abort if gui was destroyed
	      return;
	    }
